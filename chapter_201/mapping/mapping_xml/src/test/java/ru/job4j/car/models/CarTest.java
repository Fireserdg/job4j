...
public class CarTest {
    ...
    public void whenCreateCarThenGetResult() {
        ...
        assertThat(first.getModel(), is("BMW"));
        assertThat(first.getCarBody(), is(new CarBody("Body")));
