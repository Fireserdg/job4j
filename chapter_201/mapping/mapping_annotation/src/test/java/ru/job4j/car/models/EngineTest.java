...
public class EngineTest {
    ...
    public void whenCreateCarThenGetResult() {
        ...
        assertThat(first.getName(), is("Engine"));
    ...
    public void whenUpdateCarThenGetResult() {
        first.setId(2L);
        first.setName("EngineUp");
        first.setCars(List.of(new Car("Car1Up"),
                new Car("Car2Up"), new Car("Car3Up")));
        assertThat(first.getId(), is(2L));
        assertThat(first.getName(), is("EngineUp"));
        assertThat(first.getCars().get(0).getName(), is("Car1Up"));
        assertThat(first.getCars().get(1).getName(), is("Car2Up"));
        assertThat(first.getCars().get(2).getName(), is("Car3Up"));
    }

    @Test
    public void whenCheckEqualsAndHashCode() {
        var second = new Engine("Engine");
        second.setId(1L);
    ...
    public void whenGetStringRepresentation() {
        var expect = "Engine{id=1, name=Engine}";
